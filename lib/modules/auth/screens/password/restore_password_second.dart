...
class RestorePasswordSecondScreen extends StatefulWidget implements Navigateable {
  @override
  String getName() {
    return Routes.restore_pass_second;
  }

  @override
  _RestorePasswordSecondState createState() => _RestorePasswordSecondState();
}

class _RestorePasswordSecondState extends State<RestorePasswordSecondScreen>
    with ModalHelper {
  String? code;
                  ...
                  VerificationCode(
                    ...
                    onCompleted: (String value) {
                      ...
                      Provider.of<AuthProvider>(context, listen: false)
                          ...
                          context, Routes.restore_pass_third))
                          .catchError((err) {
                        print(err);
