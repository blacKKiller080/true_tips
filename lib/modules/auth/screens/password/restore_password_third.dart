...
class RestorePasswordThirdScreen extends StatefulWidget implements Navigateable {
  @override
  String getName() {
    return Routes.restore_pass_third;
  }

  @override
  _RestorePasswordThirdScreenState createState() => _RestorePasswordThirdScreenState();
}

class _RestorePasswordThirdScreenState extends State<RestorePasswordThirdScreen>
    with ModalHelper {
              ...
              CommonButton(
                ...
                onPressed: isLoading
                  ...
                  Provider.of<AuthProvider>(context, listen: false)
                      ...
                      .then((value){success(context, 'Ваш пароль успешно изменен!');
